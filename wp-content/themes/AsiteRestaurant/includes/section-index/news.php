<div class="news section" id="news">
	<div class="bamboo">
		<img src="http://localhost:8080/nhahang/wp-content/themes/AsiteRestaurant/template/viethouse/img/content/bamboo.png" alt="">
	</div>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			...
			<div class="col-md-10 col-sm-11 col-xs-12">
				...
				<div class="article">
					...
					<a href="#" class="butt align left">Читать дальше ></a>
				</div>
			</div>
		</div>
	</div>
