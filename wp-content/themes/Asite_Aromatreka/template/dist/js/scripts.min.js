...
$(document).ready(function(){$("#fast-slider").owlCarousel({items:1,nav:!0,navText:["",""]}),$("#menu-slider").owlCarousel({items:1,nav:!0,navText:["<img src=/img/arrowleft.png>","<img src=/img/arrowright.png>"]}),$("#gallery-slider").owlCarousel({items:1,nav:!0,navText:["",""]})});