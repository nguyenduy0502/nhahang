...
$(document).ready(function(){$("#fast-slider").owlCarousel({items:1,nav:!0,navText:["",""]}),$("#menu-slider").owlCarousel({items:1,nav:!0,navText:["<img src=http://aromatreka.ru/wp-content/themes/Asite_Aromatreka/template/dist/img/arrowleft.png>","<img src=http://aromatreka.ru/wp-content/themes/Asite_Aromatreka/template/dist/img/arrowright.png>"]}),$("#gallery-slider").owlCarousel({items:1,nav:!0,navText:["",""]})});