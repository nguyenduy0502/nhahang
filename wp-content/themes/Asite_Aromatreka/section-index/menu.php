    ...
    <div class="inner-middle">
        <div class="container">
            ...
            <div class="owl-carousel">
                ...
                <?php $counter = 1; ?>
                <div class="item" id="item-desserts0" data-page="2">
                                            ...
                                            <li class="product-name">
                                                <a class="product-line"
                                                   ...
                                                   data-img="<?php the_post_thumbnail_url('large')?>">
                                                    ...
                                                    <span class="product-price"><?php echo get_price_food($post->ID)?></span>
                                                </a>
                                            </li>
                                            <li class="product-description"><?php echo get_ingredient_food($post->ID);?></li>

                                            <?php $post_ids[] = get_the_ID();  endwhile; endif; wp_reset_query(); ?>
                                    </ul>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="arrow animated bounce infinite">
                        <a href="#map">
                            <img width="40" height="40" src="img/arrowspurple.png">
                        </a>
                    </div>
                    <!-- END Arrow down -->
                </div>
